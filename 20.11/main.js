...
//         } else {
//             throw new Error(`ID ${id} məlumatı tapılmadı!`);
//         }
//     } catch (error) {
//         console.error(error)
...
//         } else {
//             throw new Error(`${key} mövcud deyil`)
//         }
//     } catch (error) {
//         console.error(error)
//     }
...
// let operator = ["050", "051", "055", "077", "070", "099"]
// const updateUser = () => {
//     try {
//         users.forEach((item)=> {
//             let number = item.phone;
//             let newOperator = operator[random(operator.length)];
//             let randomNumber = `${random(10)}${random(10)}${random(10)}-${random(10)}${random(10)}-${random(10)}${random(10)}`
